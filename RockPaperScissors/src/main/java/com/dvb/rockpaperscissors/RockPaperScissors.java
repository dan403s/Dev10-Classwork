 ...
 */
package com.dvb.rockpaperscissors;
...
public class RockPaperScissors {
    ...
    public static void main(String[] args) {
        ...
        RockPaperScissors rockPaperScissorsInstance = new RockPaperScissors();
        ...
        do {
            ...
            totalRounds = rockPaperScissorsInstance.promptUser("How many rounds do you wish to play sir/madam (between 1 and 10)? ");

            // detemine if user entered rounds correctly
            if (!rockPaperScissorsInstance.isNumberValid(totalRounds, 1, 10)) {
            ...
            while (currentRound <= totalRounds) {
                ...
                do {
                    userChoice = rockPaperScissorsInstance.promptUser("Please choose (1 for rock, 2 for paper, 3 for scissors) ");
                    isValidUserChoice = rockPaperScissorsInstance.isNumberValid(userChoice, 1, 3);
                } while (!isValidUserChoice);

                // print user choice as string
                System.out.println("User chose " + rockPaperScissorsInstance.determineStringOfChoice(userChoice));

                // generate random computer choice
                computerChoice = rockPaperScissorsInstance.generateRandomChoice();

                // print computer choice as string
                System.out.println("Computer chose " + rockPaperScissorsInstance.determineStringOfChoice(computerChoice));
                ...
                roundWinner = rockPaperScissorsInstance.determineRoundWinner(userChoice, computerChoice);
            ...
            userPlayAgain = rockPaperScissorsInstance.promptUser("Do you wish to play again sir/madam (yes/no)? ");
