 ...
 */
package com.dvb.luckysevensrefactored;
...
public class LuckySevensRefactored {
    ...
    // play LuckySevens method
    public void playLuckySevens() {
        // instantiate new LuckySevens object
        LuckySevensRefactored luckySevensRefactoredInstance = new LuckySevensRefactored();
        ...
        while (currentMoney > 0) {
            die1 = luckySevensRefactoredInstance.rollDie();
            die2 = luckySevensRefactoredInstance.rollDie();
