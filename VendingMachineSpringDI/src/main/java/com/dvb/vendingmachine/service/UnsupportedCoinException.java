 ...
 * @author Daniel Bart
 */
public class UnsupportedCoinException extends Exception {
    ...
    public UnsupportedCoinException(String message) {
        super(message);
    }
    ...
    public UnsupportedCoinException(String message, Throwable cause) {
        super(message, cause);
    }
