 ...
 * @author Daniel Bart
 */
public class BuyerCartEmptyException extends Exception {
    ...
    public BuyerCartEmptyException(String message) {
        super(message);
    }
    ...
    public BuyerCartEmptyException(String message, Throwable cause) {
        super(message, cause);
    }
