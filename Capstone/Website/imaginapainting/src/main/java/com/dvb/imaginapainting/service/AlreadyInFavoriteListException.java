 ...
 * @author Daniel Bart
 */
public class AlreadyInFavoriteListException extends Exception {
    ...
    public AlreadyInFavoriteListException(String message) {
        super(message);
    }
    ...
    public AlreadyInFavoriteListException(String message, Throwable cause) {
        super(message, cause);
    }
}
