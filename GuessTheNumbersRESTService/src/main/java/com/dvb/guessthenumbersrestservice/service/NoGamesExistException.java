 ...
 * @author Daniel Bart
 */
public class NoGamesExistException extends Exception {
    ...
    public NoGamesExistException(String message) {
        super(message);
    }
    ...
    public NoGamesExistException(String message, Throwable cause) {
        super(message, cause);
    }
