 ...
 * @author Daniel Bart
 */
public class NoRoundsForGameIdException extends Exception {
    ...
    public NoRoundsForGameIdException(String message) {
        super(message);
    }
    ...
    public NoRoundsForGameIdException(String message, Throwable cause) {
        super(message, cause);
    }
