...
SELECT FirstName, 
	LastName, 
	City 
FROM client WHERE City IN ('Metairie', 'Kenner', 'Gretna');
...
SELECT FirstName, 
	LastName, 
    BirthDate 
FROM client WHERE BirthDate BETWEEN '1980-01-01' AND '1989-12-31';
...
SELECT FirstName, 
	LastName, 
    BirthDate 
FROM client WHERE BirthDate >= '1980-01-01' 
...
SELECT FirstName, 
	LastName, 
	City 
FROM client WHERE (LastName LIKE 'L%' OR LastName LIKE 'M%' OR LastName LIKE 'N%') 
AND City = 'LaPlace';
...
SELECT InvoiceId, 
    ...
    ServiceDate, 
    Price * Quantity 
FROM invoicelineitem WHERE Price * Quantity BETWEEN 15 AND 25;
