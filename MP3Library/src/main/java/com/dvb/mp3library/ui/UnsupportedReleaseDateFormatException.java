 ...
 * @author Daniel Bart
 */
public class UnsupportedReleaseDateFormatException extends Exception {
    ...
    public UnsupportedReleaseDateFormatException(String message) {
        super(message);
    }
    ...
    public UnsupportedReleaseDateFormatException(String message, Throwable cause) {
        super(message, cause);
    }
