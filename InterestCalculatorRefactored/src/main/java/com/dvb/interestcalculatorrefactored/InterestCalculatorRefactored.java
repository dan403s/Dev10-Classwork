 ...
 */
package com.dvb.interestcalculatorrefactored;
...
public class InterestCalculatorRefactored {
    ...
    public void calculateInterest() {
        ...
        InterestCalculatorRefactored interestCalculatorRefactoredInstance = new InterestCalculatorRefactored();
        ...
        for(int i = 1; i <= numberOfYears; i++) {
            ...
            for(int j = 0; j < numberOfCompoundingPeriods; j++) {
                double interestGenerated = interestCalculatorRefactoredInstance.getInterest(currentBalance, annualInterestRate, numberOfCompoundingPeriods);
