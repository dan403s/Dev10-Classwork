 ...
 */
package com.dvb.mp3libraryrefactored.controller;
...
public class MP3LibraryController {
    ...
    // ADD MP3 ---------------------------------------------------------------------
    // coordinate add MP3
    private void createMp3() throws MP3LibraryPersistenceException {
    ...
    private void showAllMp3s() throws MP3LibraryPersistenceException {
    ...
    private void showMp3Details() throws MP3LibraryPersistenceException {
    ...
    private void searchLibrary() throws MP3LibraryPersistenceException {
