 ...
 */
package com.dvb.fibonaccinumberswithrecursivemethod;
 ...
 * @author Daniel Bart
 */
public class FibonacciNumbersWithRecursiveMethod {
    ...
    public static void main(String[] args) {
        ...
        while (doContinue) {
            ...
            System.out.println("Answer: " + fibonacciMethod.fib(userInput));
