...
public class UserIOConsoleImpl implements UserIO {
    ...
    @Override
    public LocalDate readReleaseDate(String prompt) throws UnsupportedIOFormatException {
        String responseString;
        ...
        do {
            try {
                try {
                    ...
                    throw new UnsupportedIOFormatException("ERROR!!! INCORRECT DATE FORMAT!!!", e);
                }
            } catch (UnsupportedIOFormatException ex) {
                System.out.println(ex.getMessage());
            }
