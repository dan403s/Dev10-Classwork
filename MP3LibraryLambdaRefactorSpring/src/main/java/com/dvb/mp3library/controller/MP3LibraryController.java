...
public class MP3LibraryController {
    ...
    public void run() {
        ...
        while (keepGoing) {
            ...
            try {
                ...
                switch (menuSelection) {
                    ...
                    case 6:
                        ...
                        break;
                    case 7:
                        listAllMp3sReleasedInLastNumberOfYears();
                        break;
                    case 8:
                        listAllMp3sInGenreByArtist();
                        break;
                    case 9:
                        listAllMp3sByArtist();
                        break;
                    ...
                    case 13:
                        ...
                        break;
                    case 14:
                        listAverageNumberOfNotesPerMp3();
                        break;
                    case 15:
                        keepGoing = false;
                        break;
            ...
            } catch (MP3LibraryDaoException | UnsupportedIOFormatException e) {
    ...
    // ADD MP3 ---------------------------------------------------------------------
    // coordinate add MP3
    private void createMp3() throws MP3LibraryDaoException, UnsupportedIOFormatException {
    ...
    // EDIT MP3 --------------------------------------------------------------------
    // coordinate edit MP3
    private void editMp3() throws MP3LibraryDaoException, UnsupportedIOFormatException {
    ...
    public void listAllMp3sReleasedInLastNumberOfYears() throws MP3LibraryDaoException {
        view.displayMp3ReleasedInLastNYearsBanner();
        int years = view.getYearsForMp3sReleasedInLastNYears();
        List<MP3> mp3List = dao.listAllMp3sReleasedInLastNumberOfYears(years);
        view.displayMp3List(mp3List);
        view.displayContinueToMenuBanner();
    }
    ...
    public void listAllMp3sByArtist() throws MP3LibraryDaoException {
        view.displayListMp3sByArtistBanner();
        String artist = view.getArtistForListAllMp3sByArtist();
        List<MP3> mp3List = dao.listAllMp3sByArtist(artist);
        view.displayMp3List(mp3List);
        view.displayContinueToMenuBanner();
    }

    // Find all the MP3s released on a particular album ----------------------------
    public void listAllMp3sByAlbum() throws MP3LibraryDaoException {
        view.displayListMp3sByAlbumBanner();
        String album = view.getAlbumForListAllMp3sByAlbum();
        List<MP3> mp3List = dao.listAllMp3sByAlbum(album);
        view.displayMp3List(mp3List);
        view.displayContinueToMenuBanner();
    }

    // Find the average age of the MP3s in the collection --------------------------
    public void listAverageAgeOfAllMp3s() throws MP3LibraryDaoException {
        view.displayListAverageAgeOfMp3sBanner();
        double age = dao.listAverageAgeOfAllMp3s();
        view.displayListAverageAgeOfMp3s(age);
        view.displayContinueToMenuBanner();
    }

    // Find the newest MP3 in your collection --------------------------------------
    public void listNewestMp3() throws MP3LibraryDaoException {
        view.displayListNewestMp3Banner();
        MP3 mp3 = dao.listNewestMp3();
        view.displayMp3Details(mp3);
        view.displayContinueToMenuBanner();
    }

    // Find the oldest MP3 in your collection --------------------------------------
    public void listOldestMp3() throws MP3LibraryDaoException {
        view.displayListOldestMp3Banner();
        MP3 mp3 = dao.listOldestMp3();
        view.displayMp3Details(mp3);
        view.displayContinueToMenuBanner();
    }
